...
namespace Microsoft.ResourceManagement.ObjectModel.ResourceTypes {
    ...
    public partial class RmPerson : RmResource {
        ...
        /// <summary>
        /// Cost Center Id
        /// Identify cost center uniquely
        /// </summary>
        public RmReference CostCenterId {
            get { return GetReference(AttributeNames.CostCenterId);  }
            set { base[AttributeNames.CostCenterId].Value = value;  }
        }
        #endregion
        ...
        protected override void EnsureSpecificAttributesExist() {
            ...
            EnsureCustomAttributesExist(AttributeNames.CostCenterId, false);
        }
        ...
        public sealed new partial class AttributeNames {
            ...
            /// </summary>
            public static RmAttributeName CostCenterId = new RmAttributeName(@"labCostCenterId");
        }
